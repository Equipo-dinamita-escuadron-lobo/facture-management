...
public class FacturePDFAdapter implements FactureGeneratePDFOutputPort {
         ...
         * ByteArrayInputStream imageBais = new
         * ByteArrayInputStream(imageBaos.toByteArray());
         ...
         * enterpriseData.addCell(new
         * Cell().add(enterprise.getEntName()).setTextAlignment(TextAlignment.CENTER)
         * .setBorder(Border.NO_BORDER));
         * enterpriseData.addCell(new Cell().add(boldText("Direccion: ",
         * enterprise.getEntAddress()))
         * .setTextAlignment(TextAlignment.CENTER).setBorder(Border.NO_BORDER));
         * enterpriseData.addCell(new Cell().add(boldText("NIT: ",
         * enterprise.getEntNIT()))
         * .setTextAlignment(TextAlignment.CENTER).setBorder(Border.NO_BORDER));
         * enterpriseData.addCell(new Cell().add(boldText("Contacto: ",
         * enterprise.getEntContact()))
         * .setTextAlignment(TextAlignment.CENTER).setBorder(Border.NO_BORDER));
         * enterpriseData.addCell(new Cell().add(new
         * Paragraph("Factura Electrónica de compra"))
         * .setTextAlignment(TextAlignment.CENTER).setBorder(Border.NO_BORDER));
         ...
         * } else {
         * enterpriseDetails.addCell(new
         * Cell().add("Imagen no encontrada").setBorder(Border.NO_BORDER));
         * }
         * enterpriseDetails.addCell(new
         * Cell().add(enterpriseData).setBorder(Border.NO_BORDER));
         * document.add(enterpriseDetails);
         * document.add(new Paragraph(" "));
         * 
         * // Añadir codigo CUFE
         * document.add(boldText("CODIGO CUFE: ",
         * generateCUFE()).setTextAlignment(TextAlignment.CENTER)
         * .setFontSize(8));
         * 
         * // Tabla detalles de factura
         * Table invoiceDetails = new Table(2);
         * invoiceDetails.setWidthPercent(100);
         * invoiceDetails.addCell(new Cell().add(boldText("FECHA DE EMISIÓN: ",
         * String.valueOf(LocalDate.now()))));
         * invoiceDetails.addCell(new Cell().add(boldText("AUT. NUMERACIÓN FAC: ",
         * facture.getFactCode())));
         * invoiceDetails.addCell(new Cell().add(boldText("HORA DE EMISIÓN: ",
         * dateFormat.format(date))));
         * invoiceDetails.addCell(new Cell().add(boldText("FECHA DE VENCIMIENTO: ",
         * formattedExpirationDate)));
         * document.add(invoiceDetails);
         * 
         * // Tabla detalles del Emisor
         * document.add(new
         * Paragraph("DATOS DEL EMISOR").setTextAlignment(TextAlignment.CENTER).setBold(
         * ));
         * Table transmitterDetails = new Table(2);
         * transmitterDetails.setWidthPercent(100);
         * transmitterDetails.addCell(new Cell().add(boldText("NIT: ",
         * enterprise.getEntNIT())));
         * transmitterDetails.addCell(new Cell().add(boldText("CONTACTO: ",
         * enterprise.getEntContact())));
         * transmitterDetails.addCell(new Cell().add(boldText("NOMBRE: ",
         * enterprise.getEntName())));
         * transmitterDetails.addCell(new Cell().add(boldText("DIRECCION: ",
         * enterprise.getEntAddress())));
         * document.add(transmitterDetails);
         * 
         * // Tabla detalles del tercero
         * document.add(new
         * Paragraph("DATOS DEL CLIENTE").setTextAlignment(TextAlignment.CENTER).setBold
         * ());
         ...
         * + "")));
         * clientDetails.addCell(new Cell().add(boldText("DEPARTAMENTO: ",
         * third.getProvince())));
         * clientDetails.addCell(new Cell().add(boldText("TIPO DE DOCUMENTO: ",
         * third.getTypeId())));
         * clientDetails.addCell(new Cell().add(boldText("CIUDAD: ", third.getCity())));
         * clientDetails.addCell(new Cell().add(boldText("NÚMERO DE DOCUMENTO: ",
         * third.getIdNumber() + "")));
         * clientDetails.addCell(new Cell().add(boldText("TELEFONO: ",
         * third.getPhoneNumber())));
         * clientDetails.addCell(
         * new Cell().add(boldText("NOMBRE DE CLIENTE: ",
         * third.getNames() + " " + third.getLastNames())));
         * clientDetails.addCell(new Cell().add(boldText("CORREO: ",
         * third.getEmail())));
         * clientDetails.addCell(new Cell().add(boldText("DIRECCIÓN DEL CLIENTE: ",
         * third.getAddress())));
         * clientDetails.addCell(new Cell().add(boldText("TIPO DE PERSONA: ",
         * third.getPersonType())));
         * document.add(clientDetails);
         * 
         * // tabla de productos
         * document.add(new
         * Paragraph("PRODUCTOS").setTextAlignment(TextAlignment.CENTER).setBold());
         * Table itemTable = new Table(new float[] { 1, 3, 1, 2, 2 });
         * itemTable.setWidthPercent(100);
         * itemTable.addHeaderCell(
         * new Cell().add(new Paragraph("CANTIDAD").setBold())
         * .setBackgroundColor(Color.LIGHT_GRAY));
         * itemTable.addHeaderCell(
         * new Cell().add(new Paragraph("DESCRIPCIÓN").setBold())
         * .setBackgroundColor(Color.LIGHT_GRAY));
         * itemTable.addHeaderCell(
         * new Cell().add(new
         * Paragraph("IVA").setBold()).setBackgroundColor(Color.LIGHT_GRAY));
         * itemTable.addHeaderCell(
         * new Cell().add(new Paragraph("PRECIO UNITARIO").setBold())
         * .setBackgroundColor(Color.LIGHT_GRAY));
         * itemTable.addHeaderCell(
         * new Cell().add(new Paragraph("VALOR TOTAL").setBold())
         * .setBackgroundColor(Color.LIGHT_GRAY));
         * 
         * // Productos
         ...
         * Paragraph(currencyFormat.format(p.getUnitPrice()))));
         * itemTable.addCell(new Cell()
         * .add(new Paragraph(currencyFormat.format((p.getAmount() *
         * p.getUnitPrice())))));
         * }
         * 
         * itemTable.addCell(new Cell().add(boldText("Cantidad Total: ",
         * facture.getFactProducts().size() + "")));
         ...
         * summaryTable.addCell(new
         * Cell().add("SUBTOTALES").setBold().setBackgroundColor(Color.LIGHT_GRAY));
         * summaryTable.addCell(new
         * Cell().add(currencyFormat.format(facture.getFactSubtotals())));
         * summaryTable
         * .addCell(new Cell().add("IMPUESTO SOBRE LAS VENTAS").setBold()
         * .setBackgroundColor(Color.LIGHT_GRAY));
         * summaryTable.addCell(new
         * Cell().add(currencyFormat.format(facture.getFacSalesTax())));
         * summaryTable.addCell(new
         * Cell().add("RETFUENTE 2.5%").setBold().setBackgroundColor(Color.LIGHT_GRAY));
         * summaryTable.addCell(new
         * Cell().add(currencyFormat.format(facture.getFacWithholdingSource())));
         * summaryTable.addCell(new
         * Cell().add("TOTAL A PAGAR").setBold().setBackgroundColor(Color.LIGHT_GRAY));
         * summaryTable.addCell(new Cell().add((currencyFormat
         ...
         * Table table = new Table(new float[] { 4, 1 }); // 80% para el texto, 20% para
         * el QR
         * table.setWidth(UnitValue.createPercentValue(100)); // Establecer ancho total
         * de la tabla al 100%
         * 
         ...
         * 
         * table.addCell(new
         * Cell().add(textoFactura).setBackgroundColor(Color.LIGHT_GRAY));
         * 
         * // Generar la imagen del código QR y agregarla en la segunda columna
         * Image qrCodeImage = generateQRCodeImage(
         * "https://www.youtube.com/watch?v=wohwc9MQt6A&ab_channel=BryantMyers"); //
         * Cambia
         * // la URL
         * // si lo
         * // deseas
         * table.addCell(new
         * Cell().add(qrCodeImage.setHorizontalAlignment(HorizontalAlignment.CENTER)));
         * 
         ...
         * 
         * document.add(new
         * Paragraph("**FACTURA GENERADA CON FINES EDUCATIVOS, NO TIENE NINGUN VALOR LEGAL**"
         * )
        ...
        private byte[] generateInvoiceSalePdf(Facture facture) throws IOException {
                ...
                try {
                        ...
                        // Generar la imagen del código QR y agregarla en la segunda columna
                        Image qrCodeImage = generateQRCodeImage(
                                        "https://www.youtube.com/watch?v=wohwc9MQt6A&ab_channel=BryantMyers"); // Cambia
                                                                                                               // la URL
                                                                                                               // si lo
                                                                                                               // deseas
        ...
        private String generateCUFE() {
                ...
                return hexCode.substring(0, length); // Asegura que sea de exactamente 82 caracteres
        }
